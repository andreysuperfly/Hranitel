...
public static class CooldownConstants
{
    ...
    /// <summary> После изменения времени (начала/конца) расписания можно ещё менять время столько минут (чтобы поправить, если случайно выставил не то). </summary>
    public const int ScheduleEditGraceMinutes = 5;
